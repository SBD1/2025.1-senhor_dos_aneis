...
ALTER TABLE cenario ADD COLUMN IF NOT EXISTS norte_id INT;
ALTER TABLE cenario ADD COLUMN IF NOT EXISTS leste_id INT;
ALTER TABLE cenario ADD COLUMN IF NOT EXISTS oeste_id INT;
ALTER TABLE cenario ADD COLUMN IF NOT EXISTS sul_id INT;
