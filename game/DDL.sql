...
CREATE TABLE IF NOT EXISTS item (
    ...
    nome VARCHAR(50) NOT NULL,  -- Aumentado para permitir nomes como "Espada Andúril de Aragorn"
    peso NUMERIC(5,2),
    durabilidade INT CHECK (durabilidade >= 0)  -- Impede valores negativos
);
...
CREATE TABLE IF NOT EXISTS inventario (
    ...
    itens_texto TEXT,  -- Lista descritiva dos itens (ex: "Espada Andúril, Lembas élficas")
...
CREATE TABLE IF NOT EXISTS arma (
    ...
    forca INT CHECK (forca >= 0),  -- Força da arma (ex: Espada de Morgul com forca 70)
